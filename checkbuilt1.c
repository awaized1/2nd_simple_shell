...
/**
 * help_all - Code replacesDisplays all possible builn  commands.
 */
...
/**
 * help_alias -code provides in command 'alias'.
 */
...
/**
 * help_cd - code Displays info on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
